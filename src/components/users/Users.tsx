...
import {mapDispatchToProps, mapStateToProps} from './UsersContainer';




class Users extends React.Component<ReturnType<typeof mapStateToProps> & ReturnType<typeof mapDispatchToProps>>{
    componentDidMount() {
